...
On September 16, 2026, a connector-only package generated by the live builder was successfully:

1. Connected to the public DeepWiki MCP server.
2. Exported as a v1.28 package.
3. Validated by the builder with 41 passing checks and no warnings or failures.
4. Sideloaded into Copilot Cowork.
5. Used to query documentation for the `microsoft/TypeScript` GitHub repository.
